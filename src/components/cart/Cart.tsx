...
const Cart: FC<CartProps> = ({
  ...
  const formattedSubtotal = subtotal !== undefined ? subtotal.toFixed(2) : '0.00';
            ...
            <div className="flex forHeight flex-col overflow-y-scroll bg-white">
              ...
              <div className="flex-1 overflow-y-auto py-2 sm:px-2">
                <div className="flex items-start justify-between">
                  <h1 id="cart-title" className="text-[16px] font-[500] text-[#1D1F22]">
                    <span className="font-[700]">My Bag,</span> {totalCartQuantity} items
                  </h1>
                  <button
                    onClick={onClose}
